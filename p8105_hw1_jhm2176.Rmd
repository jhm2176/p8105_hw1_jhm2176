...
This helps explain my results above when taking means for each variable in the {r means} code chunk. It did **not** work for the character vector and factor vector because these variables were not numeric or logical. After coercion, however, the mean of the converted factor vector is `r mean(as.numeric(p2_df$vec_fac))`.
